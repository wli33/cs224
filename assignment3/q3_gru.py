...
class SequencePredictor(Model):
    ...
    def add_prediction_op(self):
        ...
        #dtype: Required if initial_state is not provided or RNN state has a heterogeneous dtype.
        preds = tf.tanh(preds)
    ...
    def add_training_op(self, loss):
        ...
        if self.config.clip_gradients:
            grads, self.grad_norm = tf.clip_by_global_norm(grads,tf.clip_by_global_norm)
